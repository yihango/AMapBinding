...
namespace AMap3DBinding.iOS
{
    ...
    interface MAMapView_Overlay
    {
        ...
        void InsertOverlayatIndex(MAOverlay overlay, nuint index, MAOverlayLevel level);
    ...
    interface MAMapViewDelegate
    {
        ...
        void MapViewDnnotationView(MAMapView mapView, MAAnnotationView view, MAAnnotationViewDragState newState, MAAnnotationViewDragState oldState);
        ...
        void MapViewAnnotationView(MAMapView mapView, MAAnnotationView view, UIControl control);
